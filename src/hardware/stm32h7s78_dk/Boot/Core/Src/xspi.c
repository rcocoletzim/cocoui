...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  */
    ...
    PN5     ------> XSPIM_P2_IO3
    */
    GPIO_InitStruct.Pin = GPIO_PIN_1|OCTOSPI_IO1_Pin|OCTOSPI_DQS_Pin|OCTOSPI_IO7_Pin
                          |OCTOSPI_IO6_Pin|OCTOSPI_IO5_Pin|OCTOSPI_IO0_Pin|OCTOSPI_CLK_Pin
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  /* USER CODE END XSPI2_MspDeInit 0 */
    ...
    PN5     ------> XSPIM_P2_IO3
    */
    HAL_GPIO_DeInit(GPION, GPIO_PIN_1|OCTOSPI_IO1_Pin|OCTOSPI_DQS_Pin|OCTOSPI_IO7_Pin
                          |OCTOSPI_IO6_Pin|OCTOSPI_IO5_Pin|OCTOSPI_IO0_Pin|OCTOSPI_CLK_Pin
                          |OCTOSPI_IO4_Pin|OCTOSPI_IO2_Pin|OCTOSPI_IO3_Pin);
